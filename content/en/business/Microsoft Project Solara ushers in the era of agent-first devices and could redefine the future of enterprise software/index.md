...
cover:
  image: "capa.webp"
  alt: "Microsoft Project Solara and the next generation of agent-first devices for enterprises"
  caption: "Microsoft is betting on an AI agent-centric architecture to redefine the next generation of enterprise computing."
faq:
  - pergunta: "What is Microsoft's Project Solara?"
    resposta_curta: "Project Solara is an agent-first platform developed by Microsoft to make AI agents the primary interface between users and enterprise systems."
    resposta_longa: "Introduced during Build 2026, Project Solara combines hardware, cloud infrastructure, and artificial intelligence to create agent-driven devices. Its goal is to reduce reliance on traditional software applications and enable AI agents to execute tasks directly within enterprise environments."

  - pergunta: "How does Project Solara work?"
    resposta_curta: "The platform connects intelligent devices to AI agents running in the cloud."
    resposta_longa: "Project Solara uses an architecture built on the Microsoft Device Ecosystem Platform (MDEP), allowing devices to function as intelligent endpoints connected to AI agents capable of accessing systems, understanding context, and executing complete workflows."

  - pergunta: "What is the difference between AI agents and traditional applications?"
    resposta_curta: "Applications require direct user interaction, while AI agents can perform tasks based on context and intent."
    resposta_longa: "In the traditional software model, users must navigate multiple applications to complete tasks. In an agent-first architecture, AI agents act as intelligent intermediaries that access systems, coordinate services, and execute processes with less human intervention."

  - pergunta: "Why is Project Solara important for businesses?"
    resposta_curta: "Because it can improve productivity and simplify enterprise operations."
    resposta_longa: "Microsoft's initiative signals a structural shift in enterprise software. Organizations may reduce operational complexity, accelerate internal workflows, and expand automation through AI agents capable of interacting directly with databases, CRMs, ERPs, and other business platforms."

  - pergunta: "What is the relationship between Project Solara and MCP?"
    resposta_curta: "MCP helps AI agents connect to enterprise systems."
    resposta_longa: "The Model Context Protocol (MCP) provides a standardized method for integrating AI agents with enterprise tools. In architectures such as Project Solara, protocols like MCP are essential for enabling secure access to data, applications, and business processes."

  - pergunta: "Will traditional applications disappear?"
    resposta_curta: "Probably not, but their role is likely to change."
    resposta_longa: "The most likely outcome is a hybrid architecture in which AI agents become the primary interaction layer while traditional applications continue operating as the execution infrastructure. Users interact with agents, and agents operate the underlying systems."

  - pergunta: "Which industries can benefit from the agent-first model?"
    resposta_curta: "Virtually any industry that relies on enterprise software."
    resposta_longa: "Financial services, healthcare, retail, manufacturing, logistics, and technology are among the sectors that can accelerate operations through intelligent agents capable of executing tasks, accessing information, and coordinating workflows."

  - pergunta: "What is the biggest challenge in adopting enterprise AI agents?"
    resposta_curta: "Governance, security, and operational control."
    resposta_longa: "As AI agents gain greater autonomy, organizations must implement auditing, traceability, permission management, and monitoring mechanisms. Operational trust is likely to become just as important as the technical capabilities of the agents themselves."
---
...
![Project Solara and the new agent-first architecture](imagem1.webp)
...
The same phenomenon is already emerging in AI-powered enterprise platforms, as discussed in [OpenAI and Salesforce accelerate the rise of agentic SaaS and force companies to rethink enterprise software](https://noticiatech.com.br/negocios/openai-e-salesforce-aceleram-era-do-saas-agentic-e-obrigam-empresas-a-repensar-seus-softwares-corporativos/).

## Solara's architecture reveals where enterprise infrastructure is heading

![Enterprise infrastructure powered by AI agents](imagem2.webp)
...
This trend was previously explored in [MCP could become the invisible infrastructure connecting AI agents to enterprise systems](https://noticiatech.com.br/inteligencia-artificial/mcp-pode-se-tornar-a-infraestrutura-invisivel-que-conecta-agentes-de-ia-aos-sistemas-corporativos/).
...
![Enterprise agents executing business processes](imagem3.webp)
