---
title: "Bill Gates warns AI could make jobs disappear faster than society can adapt"
slug: "bill-gates-mudou-tom-ia-problema-empresas"
translationKey: "bill-gates-mudou-tom-ia-problema-empresas"
date: "2026-08-27T00:20:00-03:00"
draft: false
author: "Por Aluisio Soares, fundador do blog Notícia Tech"
description: "Bill Gates is calling for limits on automation, jobs reserved for humans and new taxes on AI. Here is what it could mean for businesses."
categories:
  - "IA"
cover:
  image: "capa.webp"
  alt: "Bill Gates looking at a visual representation of artificial intelligence and workplace automation"
  caption: "Bill Gates' changing stance puts jobs, taxation and governance at the center of the next phase of AI."
faq:
  - pergunta: "Why has Bill Gates changed his tone on artificial intelligence?"
    resposta_curta: "Gates is placing greater emphasis on the economic, social and security risks associated with the rapid advancement of AI."
    resposta_longa: "Bill Gates continues to recognize major benefits from artificial intelligence, particularly in healthcare, science and education. What has changed is his priority: as AI capabilities and automation advance, he is calling for policies to manage the transition and reduce negative impacts on workers and society."
  - pergunta: "What does Human Reserved mean in Bill Gates' proposal?"
    resposta_curta: "It is the idea of reserving certain roles or tasks for humans even when AI could technically perform them."
    resposta_longa: "Bill Gates' proposal suggests that some activities could remain under human responsibility for economic or social reasons. This could be permanent for certain roles or temporary in sectors where workers may struggle to transition into other occupations."
  - pergunta: "Why does Bill Gates want to tax robots and AI tokens?"
    resposta_curta: "To reduce the economic incentive to replace workers and help fund transition measures."
    resposta_longa: "Gates argues that the tax system can favor automation because companies pay payroll-related taxes when they hire people, while equipment can receive different tax treatment. He proposes taxing robots and AI tokens to partially slow the replacement of human labor and fund retraining and social protection."
  - pergunta: "What does Bill Gates' changing position mean for businesses?"
    resposta_curta: "AI adoption may require workforce planning and governance beyond measuring productivity gains."
    resposta_longa: "Gates' argument suggests that businesses may need to evaluate not only how much AI can reduce costs or increase productivity, but also which roles will be automated, which skills will need to be developed and which human and regulatory limits may emerge."
---
...
![Bill Gates analyzing the economic impact of artificial intelligence on work](imagem-1.webp)
...
![Representation of robots and AI processing in a corporate environment](imagem-2.webp)
...
![Executives analyzing workforce planning and artificial intelligence governance](imagem-3.webp)
