...
cover:
  ...
  caption: "The rise of artificial intelligence in business has increased productivity, but it has also introduced a new category of risk known as Shadow AI."
faq:
- pergunta: "What is Shadow AI?"
  resposta_curta: "Shadow AI is the use of artificial intelligence tools without formal company approval."
  resposta_longa: "The term describes situations in which employees use platforms such as ChatGPT, Gemini, Claude, or other AI solutions without the knowledge or governance of the IT department, creating security, compliance, and data protection risks."
- pergunta: "Why are companies concerned about Shadow AI?"
  resposta_curta: "Because it can expose strategic information and sensitive data."
  resposta_longa: "When employees use external AI platforms without corporate oversight, internal documents, customer information, and confidential data may be shared with systems that do not comply with the organization's governance policies."
- pergunta: "Is Shadow AI illegal?"
  resposta_curta: "Not necessarily."
  resposta_longa: "The issue is not usually the legality of the tool itself, but the lack of policies, auditing, governance, and regulatory compliance surrounding the use of artificial intelligence."
- pergunta: "How can organizations reduce Shadow AI risks?"
  resposta_curta: "Through governance, employee training, and approved enterprise AI tools."
  resposta_longa: "Organizations that provide official AI solutions, establish clear policies, and invest in employee education are significantly more successful in reducing the informal adoption of unauthorized tools."
...
![Shadow AI in the corporate environment](imagem1.webp)
...
![AI governance risks](imagem2.webp)
...
![AI governance in organizations](imagem3.webp)
