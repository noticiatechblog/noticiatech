---
title: "OpenAI Slows Down Astra, Its New AI Model, After Discovering a Risk That Could Change the Technology Race"
slug: "openai-slows-down-astra-new-ai-model-risk-cybersecurity"
...
cover:
  ...
  caption: "Astra is being evaluated by OpenAI for its frontier cybersecurity capabilities."
faq:
  - pergunta: "What is OpenAI's Astra?"
    resposta_curta: "Astra is an OpenAI AI model currently under development and evaluation."
    resposta_longa: "Astra is a frontier artificial intelligence model being evaluated by OpenAI ahead of potential deployment. The company has disclosed preliminary assessments focused mainly on the system's cybersecurity capabilities."
  - pergunta: "Why did OpenAI slow down activities involving Astra?"
    resposta_curta: "Because the model demonstrated cybersecurity capabilities that required stricter controls."
    resposta_longa: "OpenAI said some of Astra's capabilities required stronger security measures during development and testing. As a result, the company paused internal activities that did not yet meet the new control requirements."
  - pergunta: "Has Astra been released to the public?"
    resposta_curta: "No. OpenAI is treating Astra as a model still under development and evaluation."
    resposta_longa: "OpenAI's publication presents preliminary evaluations and security measures for Astra, but it does not announce a public release of the model. The current focus is on evaluating its capabilities and preparing appropriate controls."
  - pergunta: "What does a critical cybersecurity capability mean for an AI model?"
    resposta_curta: "It means the ability to perform extremely advanced cyber operations with little or no human intervention."
    resposta_longa: "Within OpenAI's Preparedness Framework, the critical level is associated with capabilities such as identifying and developing functional exploits for severe vulnerabilities in protected systems without human intervention, or executing complex attack strategies against hardened targets."
  - pergunta: "Why is Astra important to the artificial intelligence race?"
    resposta_curta: "Because it shows that more capable AI models are also raising the level of risk that companies must control."
    resposta_longa: "The Astra case shows that competition among AI companies is not only about building more capable models, but also about controlling and protecting those capabilities. This could increase the importance of security evaluations, isolated environments and monitoring mechanisms before new models are broadly released."
  - pergunta: "What changes for companies using artificial intelligence?"
    resposta_curta: "Companies will need to treat security as a core part of adopting increasingly autonomous AI models."
    resposta_longa: "As AI models become capable of performing complex tasks, companies need to evaluate not only productivity and cost, but also permissions, system access, external tools, monitoring and operational limits. Astra reinforces this trend."
---
...
![OpenAI Astra AI model being evaluated for cybersecurity capabilities](imagem-1.webp)
...
![Autonomous artificial intelligence agent connected to enterprise systems and digital tools](imagem-2.webp)
...
![Businesses and technology professionals navigating the evolution of AI agent security](imagem-3.webp)
