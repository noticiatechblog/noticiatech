...
cover:
  ...
  caption: "The artificial intelligence race enters a new stage as Anthropic invests in proprietary AI hardware."

faq:
  - pergunta: "Why does Anthropic want to develop custom AI chips?"
    resposta_curta: "To reduce infrastructure costs, lower supplier dependence, and optimize Claude's performance."
    resposta_longa: "Building proprietary AI chips would allow Anthropic to gain greater control over its infrastructure, reduce processing costs, optimize hardware specifically for Claude, decrease dependence on Nvidia, and accelerate future AI development."

  - pergunta: "Will Anthropic stop using Nvidia GPUs?"
    resposta_curta: "Not necessarily."
    resposta_longa: "Even if Anthropic develops its own chips, the company is expected to continue relying on Nvidia GPUs for years to come. Proprietary hardware would likely complement existing infrastructure rather than replace it entirely."

  - pergunta: "How could this strategy affect OpenAI?"
    resposta_curta: "It raises the level of technological competition."
    resposta_longa: "If Anthropic succeeds in creating highly optimized hardware for Claude, it could reduce operational costs, speed up model development, and compete even more aggressively with OpenAI in the enterprise AI market."

  - pergunta: "Is Nvidia at risk of losing its leadership?"
    resposta_curta: "Not in the short term."
    resposta_longa: "Nvidia remains the undisputed leader in AI accelerators. However, initiatives like Anthropic's demonstrate that major AI companies are seeking greater independence from a single hardware supplier over the long term."

  - pergunta: "What does this mean for businesses using AI?"
    resposta_curta: "More competition could deliver better AI models at lower costs."
    resposta_longa: "As more AI companies develop proprietary hardware, competition is expected to improve infrastructure efficiency, accelerate innovation, and eventually lower AI operating costs for enterprise customers."
...
![Anthropic AI hardware strategy](imagem-1.webp)
...
If you've been following Anthropic's recent progress, you may also want to read **[Claude Challenges ChatGPT: Anthropic Launches New Feature and Intensifies the AI Race](https://noticiatech.com.br/en/artificial-intelligence/claude-challenges-chatgpt-anthropic-new-feature-ai-race/)**. To understand how the company's competitive strategy has evolved in recent months, check out **[Claude Opus 5 Puts Pressure on ChatGPT in the AI Race](https://noticiatech.com.br/en/artificial-intelligence/claude-opus-5-puts-pressure-on-chatgpt-ai-race/)**.

## Nvidia's dominance is beginning to face new challenges

![AI infrastructure and data center GPUs](imagem-2.webp)
...
![Custom AI chip concept powering enterprise AI](imagem-3.webp)
...
The growing competition around AI infrastructure is part of a broader industry shift. Learn more in **[OpenAI Enters the Hardware Race With a New Generation of ChatGPT Devices](https://noticiatech.com.br/en/artificial-intelligence/openai-enters-hardware-race-next-generation-chatgpt-devices/)**. If you'd like to compare how Claude, ChatGPT, Gemini, Grok, and Mistral currently compete in the enterprise market, read **[Which AI Is Best for Businesses in 2026? ChatGPT, Claude, Gemini, Grok, and Mistral Compared](https://noticiatech.com.br/en/artificial-intelligence/which-ai-is-best-for-businesses-2026-chatgpt-claude-gemini-grok-mistral/)**.
