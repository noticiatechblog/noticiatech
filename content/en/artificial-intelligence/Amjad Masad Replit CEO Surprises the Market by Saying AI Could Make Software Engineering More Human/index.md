---
title: "Amjad Masad, Replit CEO, Surprises the Market by Saying AI Could Make Software Engineering More Human"
slug: "amjad-masad-replit-ai-software-engineering-more-human"
translationKey: "amjad-masad-replit-ia-engenharia-software-humana"
date: 2026-08-09T00:20:00-03:00
author: "By Aluisio Soares, founder of Notícia Tech"
description: "Amjad Masad, Replit CEO, says AI could make software engineering more human. Here is what it reveals about the future of SaaS."
categories:
  - "Artificial Intelligence"
cover:
  image: "capa.webp"
  alt: "Amjad Masad, Replit CEO, in front of an artificial intelligence software development interface"
  caption: "Amjad Masad's view challenges the idea that artificial intelligence necessarily reduces the human role in software development."
faq:
  - pergunta: "What did Amjad Masad say about artificial intelligence in software engineering?"
    resposta_curta: "Amjad Masad said AI could make software engineering more human by reducing the mechanical work involved in programming."
    resposta_longa: "The Replit CEO argues that coding agents allow engineers to spend more time on ideation, problem-solving, and product decisions instead of spending much of their day writing code."
  - pergunta: "Why did Replit change its strategy around artificial intelligence?"
    resposta_curta: "Replit began prioritizing AI agents that can directly participate in software creation."
    resposta_longa: "The company recognized that AI models were becoming significantly better at programming and reorganized its platform around agents capable of turning instructions into functional software, changing the nature of work inside the company."
  - pergunta: "What is the so-called SaaSpocalypse?"
    resposta_curta: "SaaSpocalypse describes fears that AI agents could reduce the need for traditional SaaS software."
    resposta_longa: "The term emerged from a debate over a possible structural shift in the software-as-a-service market if companies begin using AI agents that can directly perform tasks that previously required multiple applications, systems, and interfaces."
  - pergunta: "Will artificial intelligence replace software engineers?"
    resposta_curta: "Amjad Masad's comments point more toward a transformation of the job than immediate replacement."
    resposta_longa: "AI already automates parts of programming, but the Replit CEO's view is that human work can shift toward higher-value activities such as problem definition, architecture, validation, product decisions, and strategic judgment."
  - pergunta: "What changes for companies that develop software?"
    resposta_curta: "Companies may be able to produce software with smaller teams and faster development cycles."
    resposta_longa: "The growth of coding agents could change costs, team structures, release speed, and even the economics of SaaS, while also increasing the importance of review, security, quality, and human oversight."
  - pergunta: "Why does the Replit CEO's statement matter to the B2B market?"
    resposta_curta: "Because Replit is directly exposed to the transformation AI agents are bringing to software development."
    resposta_longa: "Replit operates at the intersection of software development, AI, and application creation. Its CEO's view therefore offers a relevant signal about how software companies may adapt to an economy in which AI participates directly in technology production."
  - pergunta: "What could happen to the SaaS market in the coming months?"
    resposta_curta: "The market could move toward smarter software, autonomous agents, and smaller teams."
    resposta_longa: "If agents continue becoming better at creating and operating applications, some of the value currently concentrated in traditional software could shift toward platforms capable of executing tasks directly. That could pressure existing SaaS models and favor companies that put AI at the core of their products."
---
...
![Amjad Masad, Replit CEO, represents the shift from traditional software development toward an AI-agent-driven approach](imagem-1.webp)
...
![AI agents transforming a business idea into functional software and reducing the distance between business needs and development](imagem-2.webp)
