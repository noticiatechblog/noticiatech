---
title: "SAP NOW 2026 in São Paulo: Why the Enterprise Software Giant Wants to Turn Brazilian Companies into Autonomous Enterprises"
slug: "sap-now-2026-sao-paulo-autonomous-enterprises"
translationKey: "sap-now-2026-sao-paulo-autonomous-enterprises"
date: 2026-09-02T00:10:00-03:00
draft: false
author: "By Aluisio Soares, founder of Notícia Tech"
description: "SAP NOW 2026 takes place in São Paulo on September 9 and 10, focusing on AI agents, data and autonomous processes. Here's what SAP is preparing for the next phase of enterprise AI."
categories:
  - "Artificial Intelligence"
cover:
  image: "capa.webp"
  alt: "SAP NOW 2026 in São Paulo represents SAP's strategy for autonomous enterprises powered by artificial intelligence agents"
  caption: "SAP NOW AI Tour Brazil 2026 takes place in São Paulo with a focus on the evolution toward the Autonomous Enterprise model."
faq:
  - pergunta: "What is SAP NOW 2026?"
    resposta_curta: "It is SAP's main event in Brazil, taking place in São Paulo on September 9 and 10, 2026, with a focus on enterprise AI, agents, data and process automation."
    resposta_longa: "SAP NOW AI Tour Brazil 2026 will take place at the Transamerica Expo Center in São Paulo. The event will feature presentations, demonstrations, customer cases and hands-on experiences focused on artificial intelligence, data, enterprise applications and SAP's Autonomous Enterprise vision."
  - pergunta: "What does Autonomous Enterprise mean to SAP?"
    resposta_curta: "It is a vision of the enterprise in which AI participates in process execution and coordination, while people remain responsible for strategy, priorities and decisions that require judgment."
    resposta_longa: "In SAP's vision, AI agents can work with connected enterprise data, applications and processes to perform tasks and coordinate activities from end to end. The approach does not eliminate human involvement, but shifts part of operational work to AI systems with context, integration, security and governance."
  - pergunta: "What will SAP NOW 2026 show about AI agents?"
    resposta_curta: "The event will feature demonstrations of agents applied to business processes and an Agent Lab where participants can create agents with Joule Studio 2.0."
    resposta_longa: "The Agent Lab will feature ten stations equipped with Joule Studio 2.0, allowing participants to create agents using natural-language instructions with support from specialists. SAP will also demonstrate agent applications across areas such as finance, HR, procurement, supply chain, customer experience and operations."
---
...
![AI agents connected to business processes represent the shift from conversational AI to execution](imagem-1.webp)
...
Notícia Tech has already been following this transition in its analysis of **[how AI agents are transforming business process automation](https://noticiatech.com.br/en/automation/how-ai-agents-transform-business-process-automation-beyond-chatgpt-work/)**. SAP's differentiator is its attempt to bring this logic directly into an integrated enterprise infrastructure.
...
![Enterprise architecture connecting data, applications and AI agents across different business functions](imagem-2.webp)
...
![Executives observing an autonomous digital enterprise where AI agents coordinate end-to-end business processes](imagem-3.webp)
