---
title: "OpenAI Changes Strategy and Surprises the Market: Why the Battle Between Open and Closed AI Has Entered a New Phase"
slug: "openai-shifts-strategy-open-weight-ai-models"
translationKey: "openai-estrategia-ia-aberta-modelos-open-weight"
date: 2026-07-27T00:30:00-03:00
draft: false
...
cover:
  ...
  caption: "The growing rivalry between open and closed AI models could reshape the future of enterprise artificial intelligence."

faq:
  - pergunta: "What are open-weight models?"
    resposta_curta: "They are AI models whose trained weights are available so developers can build customized applications."
    resposta_longa: "Open-weight models allow organizations to run, customize and fine-tune artificial intelligence models within their own infrastructure, providing greater flexibility, privacy and operational control."

  - pergunta: "Has OpenAI started supporting open AI?"
    resposta_curta: "The company has recently supported a regulatory approach that is more favorable to open-weight models."
    resposta_longa: "Although OpenAI continues developing proprietary frontier models, it has joined industry initiatives supporting balanced regulations for open-weight AI, signaling a strategic response to the rapidly changing competitive landscape."

  - pergunta: "What does this mean for businesses?"
    resposta_curta: "Companies may gain more deployment options while reducing dependence on a single AI provider."
    resposta_longa: "The growth of open-weight AI expands competition among vendors and enables organizations to choose solutions that better fit their requirements for privacy, governance, infrastructure and long-term costs."

  - pergunta: "Do Google and Anthropic follow the same strategy?"
    resposta_curta: "Not entirely. Both companies continue adopting a more cautious approach toward model openness."
    resposta_longa: "While OpenAI, Microsoft, Nvidia and Meta increasingly support the expansion of open-weight AI, Google and Anthropic still prioritize more restrictive approaches focused on safety, governance and risk mitigation."
...
![Competition between open and closed AI models in the enterprise market](imagem-1.webp)
...
[Enterprise AI Architecture: the complete guide to understanding RAG, MCP, AI agents, automation and copilots](https://noticiatech.com.br/en/artificial-intelligence/enterprise-ai-architecture-complete-guide-rag-mcp-ai-agents-automation-copilots/)
...
![Enterprise team deploying open-weight AI infrastructure](imagem-2.webp)
...
[ChatGPT Work is changing enterprise software as businesses move beyond traditional applications](https://noticiatech.com.br/en/artificial-intelligence/chatgpt-work-changing-enterprise-software-businesses/)
...
![Executives evaluating different strategies for the future of artificial intelligence](imagem-3.webp)
