---
title: "Google Makes Gemini Live Execute Tasks on Its Own and Escalates the AI Agent Race"
slug: "google-gemini-live-execute-tasks-ai-agent-race"
translationKey: "google-gemini-live-executar-tarefas-agentes-ia"
date: "2026-08-29T00:30:00-03:00"
draft: false
author: "By Aluisio Soares, founder of Notícia Tech"
description: "Google is turning Gemini Live into a gateway for AI agents, allowing voice commands to trigger complex tasks that continue running in the background through Gemini Spark."
categories:
  - "Tools"
cover:
  image: "capa.webp"
  alt: "Gemini Live using voice commands to delegate tasks to Gemini Spark"
  caption: "Gemini Live can now turn voice conversations into complex tasks that continue running in the background through Gemini Spark."
faq:
  - pergunta: "What changed in Gemini Live?"
    resposta_curta: "Gemini Live can now delegate complex tasks to Gemini Spark."
    resposta_longa: "The update allows users to speak naturally with Gemini Live and delegate multi-step tasks to Gemini Spark. The agent can work with Google Docs, Sheets, Drive and the web while continuing to process tasks in the background."
  - pergunta: "What is Gemini Spark?"
    resposta_curta: "Gemini Spark is Google's personal AI agent designed to execute tasks autonomously."
    resposta_longa: "Gemini Spark is a cloud-based personal AI agent integrated with Google's ecosystem. It can execute recurring tasks, build workflows, use connected applications and continue working in the background under the user's direction."
  - pergunta: "Can Gemini Live manage Gmail by voice?"
    resposta_curta: "Yes. Gemini Live can help users search, summarize and manage Gmail through voice commands."
    resposta_longa: "The integration allows users to interact with their inbox using natural language instead of manually navigating Gmail. Depending on availability and permissions, Gemini can search messages, summarize information and assist with inbox actions."
  - pergunta: "Is Gemini Live becoming an AI agent?"
    resposta_curta: "Gemini Live is becoming an interface for AI agents."
    resposta_longa: "Gemini Live remains a conversational experience, but its integration with Gemini Spark allows voice commands to trigger systems capable of executing multi-step tasks. The shift brings conversational AI closer to agentic automation."
---
...
![Gemini Live delegating a complex task to Gemini Spark in the background](imagem-1.webp)
...
![Gemini Live using voice interaction to manage information from Gmail](imagem-2.webp)
...
![Gemini Daily Brief organizing information from Gmail and Calendar](imagem-3.webp)
...
![Gemini coordinating connected productivity tools as an AI agent](imagem-3.webp)
