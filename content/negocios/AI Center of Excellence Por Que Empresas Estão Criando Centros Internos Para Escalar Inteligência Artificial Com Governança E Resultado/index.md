...
cover:
  ...
  caption: "Empresas estão criando estruturas permanentes para transformar IA em capacidade operacional e vantagem competitiva."
faq:
  - pergunta: "O que é um AI Center of Excellence?"
    resposta_curta: "É uma estrutura organizacional criada para coordenar iniciativas de inteligência artificial."
    resposta_longa: "O AI Center of Excellence centraliza conhecimento, governança, padrões e melhores práticas para acelerar a adoção de IA de forma segura e escalável dentro das empresas."

  - pergunta: "Por que empresas estão criando AI Centers of Excellence?"
    resposta_curta: "Para evitar projetos isolados e gerar resultados consistentes."
    resposta_longa: "A estrutura permite padronizar processos, reduzir riscos, acelerar implementação e aumentar o retorno dos investimentos em inteligência artificial."

  - pergunta: "Qual a relação entre AI Center of Excellence e governança?"
    resposta_curta: "A governança é uma das funções centrais da estrutura."
    resposta_longa: "O modelo ajuda empresas a controlar uso de dados, compliance, segurança, métricas de desempenho e riscos associados aos agentes de IA."

  - pergunta: "AI Center of Excellence é útil apenas para grandes empresas?"
    resposta_curta: "Não."
    resposta_longa: "Empresas de médio porte também utilizam esse modelo para organizar iniciativas de IA e evitar desperdício de recursos em projetos desconectados."
---
...
![Resultados corporativos com IA](imagem2.webp)
