...
date: "2026-09-03T00:10:00-03:00"
draft: false
author: "Por Aluisio Soares, fundador do blog Notícia Tech"
description: "EUA pressionam o G20 por regras que permitam treinar modelos de IA com conteúdo protegido por direitos autorais, em meio à disputa entre tecnologia e criadores."
categories:
- "IA"
cover:
  image: "capa.webp"
  alt: "Representação do G20 diante da disputa entre inteligência artificial e direitos autorais"
  caption: "A discussão sobre treinamento de IA coloca inovação tecnológica e direitos autorais no centro da agenda internacional."
faq:
- pergunta: "O que os EUA querem que o G20 faça sobre o treinamento de IA?"
  resposta_curta: "Os EUA querem que países do G20 adotem regras que permitam o uso de obras protegidas por direitos autorais no treinamento de modelos de IA, com proteção aos criadores."
  resposta_longa: "A proposta apresentada pelo secretário de Comércio dos EUA, Howard Lutnick, defende uma estrutura que preserve a possibilidade de empresas de IA treinarem seus modelos com obras de criadores e, ao mesmo tempo, estabeleça mecanismos de proteção para artistas e outros detentores de direitos. A abordagem defendida pelos EUA inclui o princípio de fair use."
- pergunta: "O que é fair use no contexto do treinamento de IA?"
  resposta_curta: "Fair use é um princípio do direito autoral dos EUA que permite determinados usos de obras protegidas sem autorização prévia, dependendo das circunstâncias."
  resposta_longa: "No debate sobre inteligência artificial, empresas de tecnologia argumentam que utilizar obras protegidas durante o treinamento pode constituir um uso permitido e transformativo. A questão ainda é objeto de disputas judiciais, e diferentes processos podem produzir interpretações distintas sobre a aplicação do copyright ao treinamento de modelos."
- pergunta: "Quais empresas de IA estão envolvidas em disputas sobre direitos autorais?"
  resposta_curta: "OpenAI, Anthropic, Google e Meta estão entre as empresas processadas nos EUA por autores, editoras, organizações de mídia e outros criadores."
  resposta_longa: "As disputas questionam o uso de livros, textos, música, arte e outros conteúdos no desenvolvimento de sistemas de inteligência artificial. As empresas defendem a legalidade de determinadas práticas de treinamento, enquanto os detentores de direitos alegam que suas obras foram utilizadas sem autorização."
- pergunta: "O G20 já decidiu liberar o uso de conteúdo protegido para treinar IA?"
  resposta_curta: "Não. A discussão apresentada pelos EUA representa uma pressão política e regulatória, não uma decisão do G20."
  resposta_longa: "O encontro coloca o tema na agenda internacional, mas a declaração do governo dos EUA não significa que os países do G20 tenham adotado uma regra comum. O principal ponto a acompanhar é se a defesa de uma abordagem baseada em fair use conseguirá influenciar futuras estruturas regulatórias em diferentes mercados."
...
![Representação de obras digitais alimentando o treinamento de modelos de inteligência artificial](imagem-1.webp)
...
![Jensen Huang e líderes de tecnologia em discussão sobre regulamentação e futuro da inteligência artificial](imagem-2.webp)
...
![Representação global do G20 conectando governos, empresas de IA e direitos autorais](imagem-3.webp)
