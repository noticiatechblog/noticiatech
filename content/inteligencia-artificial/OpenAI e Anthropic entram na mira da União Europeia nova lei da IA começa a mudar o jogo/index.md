---
title: "OpenAI e Anthropic entram na mira da União Europeia: nova lei da IA começa a mudar o jogo"
slug: "openai-anthropic-uniao-europeia-ai-act-muda-mercado-ia"
...
cover:
  ...
  caption: "A regulamentação europeia inaugura uma nova fase para empresas que desenvolvem inteligência artificial."

faq:
  - pergunta: "Por que a União Europeia está fiscalizando OpenAI e Anthropic?"
    resposta_curta: "Porque a AI Act começou a exigir maior transparência, gestão de riscos e responsabilidade para sistemas avançados de inteligência artificial."
    resposta_longa: "Com a entrada em vigor da AI Act, empresas responsáveis por modelos avançados de IA passam a cumprir obrigações relacionadas à segurança, documentação, gerenciamento de riscos e transparência. OpenAI e Anthropic estão entre as organizações mais relevantes afetadas por esse novo cenário regulatório."

  - pergunta: "A AI Act afeta empresas fora da Europa?"
    resposta_curta: "Sim. Empresas que oferecem serviços de IA para usuários europeus também podem ser impactadas."
    resposta_longa: "A legislação possui alcance extraterritorial semelhante ao GDPR. Mesmo empresas sediadas fora da União Europeia precisam atender às exigências caso disponibilizem soluções de IA para cidadãos ou organizações europeias."

  - pergunta: "O que muda para empresas que utilizam IA?"
    resposta_curta: "A governança da IA passa a ser uma prioridade estratégica."
    resposta_longa: "Empresas precisarão investir em documentação, segurança, rastreabilidade, monitoramento e gestão de riscos para continuar utilizando soluções avançadas de inteligência artificial dentro das novas exigências regulatórias."

  - pergunta: "A AI Act pode influenciar outros países?"
    resposta_curta: "Sim. A expectativa é que diversas economias utilizem a legislação europeia como referência."
    resposta_longa: "Assim como ocorreu com a LGPD e o GDPR, especialistas acreditam que a AI Act poderá influenciar futuras regulamentações em diversos mercados, criando um novo padrão internacional para governança de inteligência artificial."
---
...
![OpenAI e Anthropic diante da bandeira da União Europeia](imagem-1.webp)
...
![Representação de centros de dados, empresas de IA e órgãos reguladores europeus](imagem-2.webp)
...
![Executivos analisando painéis de governança e conformidade em inteligência artificial](imagem-3.webp)
