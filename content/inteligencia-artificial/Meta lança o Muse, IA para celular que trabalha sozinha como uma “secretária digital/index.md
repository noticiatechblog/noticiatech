...
description: "A Meta lançou o Muse, agente de IA para celular que executa tarefas em serviços digitais, como enviar e-mails, fazer compras e reservar viagens."
categories:
  - "IA"
cover:
  image: "capa.webp"
  alt: "Muse da Meta representado como uma secretária digital executando tarefas em um computador virtual"
  caption: "O Muse transforma comandos em tarefas executadas por um agente de IA conectado a serviços digitais."
faq:
  - pergunta: "O que é o Muse da Meta?"
    resposta_curta: "O Muse é um agente de IA pessoal criado pela Meta para executar tarefas em serviços digitais."
    resposta_longa: "Diferentemente de um chatbot convencional, o Muse foi projetado para receber uma tarefa e agir para realizá-la. Ele pode executar atividades como enviar e-mails, reservar viagens e fazer compras, utilizando uma máquina virtual segura com navegador próprio."
  - pergunta: "Quando o Muse chega ao Brasil?"
    resposta_curta: "A Meta ainda não anunciou uma data para o lançamento do   Muse no Brasil."
    resposta_longa: "O Muse está sendo lançado inicialmente nos Estados Unidos para iOS, Android e web. Até o momento, a Meta não divulgou uma data específica para disponibilizar o agente oficialmente no Brasil."
  - pergunta: "O Muse funciona no celular?"
    resposta_curta: "Sim. O Muse está sendo lançado nos Estados Unidos para iOS e Android, além da web."
    resposta_longa: "A Meta projetou a interação com o Muse para funcionar como uma conversa no celular. O serviço também pode ser acessado diretamente pelo WhatsApp, enquanto a execução das tarefas ocorre no ambiente seguro do Muse Secure VM."
  - pergunta: "O Muse pode fazer compras e enviar e-mails sozinho?"
    resposta_curta: "Sim, mas ações sensíveis podem exigir autorização do usuário."
    resposta_longa: "O Muse pode realizar tarefas como enviar e-mails e fazer compras em serviços conectados. A Meta afirma que o agente consulta o usuário antes de ações sensíveis e mantém um registro das atividades realizadas e planejadas."
  - pergunta: "Qual é a diferença entre o Muse e um assistente de voz tradicional?"
    resposta_curta: "O Muse é projetado para executar objetivos com várias etapas, e não apenas comandos isolados."
    resposta_longa: "Um assistente tradicional costuma executar uma ação específica após receber um comando. O Muse foi concebido como um agente de IA que pode interpretar uma tarefa, planejar etapas e executar ações em serviços digitais conectados."
---
...
![Muse da Meta sendo usado em um smartphone para delegar uma tarefa a um agente de IA](imagem-1.webp)
...
![Interface conceitual mostrando o Muse executando compras, e-mails e reservas em uma máquina virtual segura](imagem-2.webp)
...
![Pessoa usando o celular enquanto o agente Muse trabalha sozinho em um computador virtual ao fundo](imagem-3.webp)
