---
title: "OpenAI, Anthropic e Block unem forças para criar padrão aberto de agentes de IA e acelerar a próxima fase da automação corporativa"
slug: "agentic-ai-foundation-openai-anthropic-block-padrao-agentes-ia"
...
cover:
  ...
  caption: "A criação da Agentic AI Foundation pode redefinir a forma como empresas desenvolvem, integram e escalam agentes de inteligência artificial."

faq:
  - pergunta: "O que é a Agentic AI Foundation?"
    resposta_curta: "É uma iniciativa criada para desenvolver padrões abertos para agentes de inteligência artificial."
    resposta_longa: "A Agentic AI Foundation reúne empresas do setor de IA para criar especificações abertas que permitam maior interoperabilidade entre agentes inteligentes, ferramentas e plataformas utilizadas por organizações."

  - pergunta: "Por que OpenAI, Anthropic e Block decidiram trabalhar juntas?"
    resposta_curta: "Porque a adoção corporativa exige padrões comuns entre diferentes plataformas."
    resposta_longa: "Apesar da competição comercial, empresas líderes perceberam que o crescimento do mercado depende de tecnologias interoperáveis, reduzindo custos de integração e acelerando a adoção empresarial."

  - pergunta: "Como essa iniciativa pode impactar as empresas?"
    resposta_curta: "Ela pode facilitar a implementação de agentes de IA em diferentes sistemas corporativos."
    resposta_longa: "Empresas tendem a ganhar maior liberdade para conectar agentes inteligentes a CRMs, ERPs, plataformas de atendimento, automação e sistemas internos sem depender exclusivamente de um fornecedor."

  - pergunta: "Qual a relação entre a Agentic AI Foundation e o MCP?"
    resposta_curta: "Ambos buscam aumentar a interoperabilidade entre modelos e ferramentas."
    resposta_longa: "Enquanto o MCP facilita a comunicação entre modelos e fontes de dados, iniciativas como a Agentic AI Foundation ampliam essa visão para ecossistemas completos de agentes inteligentes utilizados por organizações."
...
![Arquitetura de agentes inteligentes](imagem-2.webp)
...
![Futuro da IA corporativa](imagem-3.webp)
