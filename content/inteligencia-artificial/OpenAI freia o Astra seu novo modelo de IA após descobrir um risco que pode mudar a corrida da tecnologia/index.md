---
title: "OpenAI freia o Astra, seu novo modelo de IA, após descobrir um risco que pode mudar a corrida da tecnologia"
slug: "openai-freia-astra-novo-modelo-ia-risco-ciberseguranca"
translationKey: "openai-freia-astra-novo-modelo-ia-risco-ciberseguranca"
date: 2026-08-08T00:20:00-03:00
...
cover:
  ...
  caption: "O Astra está sendo avaliado pela OpenAI por suas capacidades de fronteira em cibersegurança."
faq:
  - pergunta: "O que é o Astra da OpenAI?"
    resposta_curta: "Astra é um modelo de IA da OpenAI em desenvolvimento e avaliação."
    resposta_longa: "O Astra é um modelo de inteligência artificial de próxima fronteira que está sendo avaliado pela OpenAI antes de uma eventual implantação. A empresa divulgou avaliações preliminares relacionadas principalmente às capacidades de cibersegurança do sistema."
  - pergunta: "Por que a OpenAI freou atividades envolvendo o Astra?"
    resposta_curta: "Porque o modelo apresentou capacidades de cibersegurança que exigiram controles mais rigorosos."
    resposta_longa: "A OpenAI informou que algumas capacidades do Astra exigiram o fortalecimento das medidas de segurança utilizadas no desenvolvimento e nos testes. Por isso, a empresa pausou atividades internas que ainda não atendiam aos novos requisitos de controle."
  - pergunta: "O Astra já foi lançado para o público?"
    resposta_curta: "Não. A OpenAI está tratando o Astra como um modelo em desenvolvimento e avaliação."
    resposta_longa: "A publicação da OpenAI apresenta avaliações preliminares e medidas de segurança para o Astra, mas não anuncia um lançamento público do modelo. O foco atual está na avaliação de capacidades e na preparação de controles adequados."
  - pergunta: "O que significa uma capacidade crítica de cibersegurança em uma IA?"
    resposta_curta: "É a capacidade de realizar operações cibernéticas extremamente avançadas com pouca ou nenhuma intervenção humana."
    resposta_longa: "No contexto do Preparedness Framework da OpenAI, o nível crítico está associado a capacidades como identificar e desenvolver exploits funcionais de vulnerabilidades graves em sistemas protegidos sem intervenção humana ou executar estratégias complexas de ataque contra alvos endurecidos."
  - pergunta: "Por que o Astra é importante para a corrida da inteligência artificial?"
    resposta_curta: "Porque mostra que o avanço dos modelos também está elevando o nível de risco que precisa ser controlado."
    resposta_longa: "O caso do Astra mostra que a competição entre empresas de IA não envolve apenas modelos mais capazes, mas também a capacidade de controlar e proteger essas capacidades. Isso pode aumentar a importância de avaliações de segurança, ambientes isolados e mecanismos de monitoramento antes da liberação de novos modelos."
  - pergunta: "O que muda para empresas que usam inteligência artificial?"
    resposta_curta: "Empresas terão de considerar segurança como parte central da adoção de modelos cada vez mais autônomos."
    resposta_longa: "À medida que modelos de IA ganham capacidade para executar tarefas complexas, empresas precisam avaliar não apenas produtividade e custo, mas também permissões, acesso a sistemas, ferramentas externas, monitoramento e limites operacionais. O avanço do Astra reforça essa tendência."
---
...
![Astra modelo de inteligência artificial da OpenAI sendo avaliado em cibersegurança](imagem-1.webp)
...
![Agente de inteligência artificial autônomo conectado a sistemas corporativos e ferramentas digitais](imagem-2.webp)
...
![Empresas e profissionais diante da evolução da segurança dos agentes de inteligência artificial](imagem-3.webp)
